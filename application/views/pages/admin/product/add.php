                        ...
                        <div class="card-body">
                          <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control <?= form_error('name') ? "is-invalid" :""?> ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image" id="image" class="form-control <?= form_error('image') ? "is-invalid" :""?>">
                                <?= form_error('image', '<div class="invalid-feedback">', '</div>')?>
                            </div>

                            <div class="form-group">
                                <label for="desc">Description</label>
                                <textarea name="desc" id="desc" class="form-control <?= form_error('desc') ? "is-invalid" :""?>"></textarea>
